...
const DICT = {
  en: {
    ...
    'nav.logout': 'Log out',
    'nav.confirmLogout': 'Log out of Groundline on every device? Your documents and history stay.',
  ...
  ru: {
    ...
    'nav.logout': 'Выйти',
    'nav.confirmLogout': 'Выйти из Groundline на всех устройствах? Документы и история останутся.',
    'nav.language': 'Язык',
